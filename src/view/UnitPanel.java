...
public class UnitPanel extends javax.swing.JPanel {
	...
	public void updateLabel() {
		this.soldi.setText(SOLDITXT
				+ gameMode.getPlayer(gameMode.getTurno()).getSoldi());
	...
	private void initComponents() {
		...
		try {
			URL imgUrl = getClass().getResource(
					"Icon pack/Unit Pack/Fanteria Leggera1_Icon.png");
		...
		try {
			URL imgUrl = getClass().getResource(
					"Icon pack/Unit Pack/Fanteria Pesante1_Icon.png");
			imgIcon = new ImageIcon(imgUrl);
		...
		try {
			URL imgUrl = getClass().getResource(
					"Icon pack/Unit Pack/Panzer1_Icon.png");
			imgIcon = new ImageIcon(imgUrl);
		...
		try {
			URL imgUrl = getClass().getResource(
					"Icon pack/Unit Pack/Aereo1_Icon.png");
			imgIcon = new ImageIcon(imgUrl);
		...
		try {
			URL imgUrl = getClass().getResource(
					"Icon pack/Unit Pack/Artiglieria1_Icon.png");
			imgIcon = new ImageIcon(imgUrl);
				...
				.addGroup(
						layout.createSequentialGroup()
								...
								.addPreferredGap(
										javax.swing.LayoutStyle.ComponentPlacement.RELATED,
										86, Short.MAX_VALUE)
								.addComponent(gioca).addContainerGap()));
	}
}
